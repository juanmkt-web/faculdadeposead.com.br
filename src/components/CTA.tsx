        ...
        <div className="max-w-6xl mx-auto animate-fade-in">
          ...
          <div className="text-center px-2">
            <a href="https://www.fasuleducacional.edu.br/posgraduacao/cursos" target="_blank" rel="noopener noreferrer">
              <Button
                size="lg"
                className="bg-accent text-accent-foreground hover:bg-[#ffc700] font-bold text-xs md:text-xl px-5 md:px-12 py-4 md:py-8 rounded-full shadow-2xl animate-pulse-cta mb-3 md:mb-8 w-full md:w-auto max-w-full whitespace-nowrap"
              >
